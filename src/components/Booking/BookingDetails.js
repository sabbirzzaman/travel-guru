...
const BookingDetails = ({ place, details }) => {
    return (
        <div className="xl:mr-14 md:mr-10 md:flex flex-col justify-center block md:max-w-lg max-w-sm md:mx-0 mx-auto md:h-[60vh] h-auto md:py-14 py-8 md:text-left text-center">
